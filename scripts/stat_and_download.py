...
# USER CONFIGURATION
# ============================================================================
# HuggingFace Token (set your token here if needed for gated models)
HF_TOKEN = None  # Replace with your token string: "hf_xxxxxxxxxxxxx"

# Use HuggingFace mirror (for faster downloads in China/AutoDL)
os.environ["HF_ENDPOINT"] = "https://hf-mirror.com"

# Set cache directory to data disk
...
# Output directory
PLOT_DIR = os.path.join(CACHE_DIR, "activation_plots")
...
def main():
    ...
    print(f"Samples per layer: {NUM_SAMPLES}")
